...
//    *Note – merge sort requires creating extra arrays which can become a memory space problem
//    as the size of array to sort grows

    // MergeSort breaks an array down into individual, single element arrays
    // then looks at each one, and builds a new sorted array of those elements
    // then copies the sorted array into the original array (the merge)
    ...
    public static void merge(int inputArray[], int start, int mid, int end){
        ...
        int rightSlot = mid+1;
        // k represents the current element index in the temp array
        // which we are using to create the new sorted array
        int k = 0;
